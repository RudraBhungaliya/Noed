...
function ProductMesh({ id, isHovered }) {
  ...
  return (
    <Float speed={isHovered ? 4 : 2} rotationIntensity={isHovered ? 2 : 1} floatIntensity={1.5}>
      <mesh ref={meshRef}>
        {id === 1 && <torusKnotGeometry args={[0.5, 0.15, 100, 16]} />}
        {id === 2 && <octahedronGeometry args={[0.7, 0]} />}
        {id === 3 && <torusGeometry args={[0.6, 0.2, 16, 100]} />}
        {id === 4 && <dodecahedronGeometry args={[0.6, 0]} />}
        {id === 5 && <icosahedronGeometry args={[0.6, 0]} />}
        {id === 6 && <coneGeometry args={[0.5, 1, 32]} />}
        {materialContent}
      </mesh>
    </Float>
  );
...
function ProductViewer({ id, isHovered }) {
  ...
  return (
    <div ref={containerRef} style={{ width: '100%', height: '100%', position: 'relative' }}>
      <View track={containerRef} style={{ width: '100%', height: '100%', position: 'absolute', top: 0, left: 0 }}>
        ...
        <ProductMesh id={id} isHovered={isHovered} />
...
const rawProducts = [
  { id: 1, name: "Articulated Dragon Model", price: "₹1,200", material: "PLA+", finish: "Matte" },
  { id: 2, name: "Geometric Desk Planter", price: "₹850", material: "PETG", finish: "Glossy White" },
  { id: 3, name: "Mechanical Gear Assembly", price: "₹2,500", material: "ABS", finish: "Industrial" },
  { id: 4, name: "Topographical City Map", price: "₹3,400", material: "Resin", finish: "High Detail Navy" },
  { id: 5, name: "Custom Keycap Set", price: "₹600", material: "Resin", finish: "Translucent" },
  { id: 6, name: "Voronoi Sculpture", price: "₹1,800", material: "Silk PLA", finish: "Metallic Blue" }
];
...
export default function Shop() {
  ...
  // Custom Card Component with 3D Mouse Tilt
      ...
      >
        ...
        <motion.div style={{ transform: "translateZ(30px)", display: 'flex', flexDirection: 'column', height: '100%' }}>
          ...
          <div style={{ 
            ...
            <ProductViewer id={product.id} isHovered={hoveredCard === product.id} />
          </div>
      ...
      <div className="page-container" style={{ padding: '40px 10%' }}>
        ...
        >
          {rawProducts.map(product => (
            <InteractiveCard key={product.id} product={product} />
          ))}
        </motion.div>
      </div>
    </PageWrapper>
